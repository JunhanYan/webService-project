...
<?php
	...
	$sql="select * from jobs where type='".urldecode($_GET[proid])."' order by jobid desc";
	}
	$rs=mysql_query($sql);
	...
	if(!urldecode($_GET[proid])){
	$sql="select * from jobs order by jobid desc limit $startno,$pagesize";
	}else{
	$sql="select * from jobs where type='".urldecode($_GET[proid])."' order by jobid desc limit $startno,$pagesize";
	}
	$rs=mysql_query($sql);
?>
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
    <tr>
      <td width="88" height="30" align="center" bgcolor="#FFFFFF" class="line2">ID</td>
	    <td width="103" align="center" bgcolor="#FFFFFF" class="line2">工作名称</td>
	    <td width="120" align="center" bgcolor="#FFFFFF" class="line2">发布时间</td>
	    <td width="120" align="center" bgcolor="#FFFFFF" class="line2">结束时间</td>
	    <td width="107" align="center" bgcolor="#FFFFFF" class="line2">类别</td>
	    <td width="126" align="center" bgcolor="#FFFFFF" class="line2">发布人/公司</td>
	...
	<tr>
	  ...
	  <?php 
        ...
        echo" <a href=details.php?jobid=$rows[jobid]>查看详情</a>";
	  ?>	 </td>
	</tr>
	<?php
	}
