    ...
    <td bgcolor="#FFFFFF"><table width="780" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
       ...
       <td align="center" background="images/button1_bg.jpg"><a href="search.php" title="高级搜索">高级搜索</a></td>
        <td align="center" background="images/button1_bg.jpg"><a href="resume.php" title="我的简历">我的简历</a></td>
        <td align="center" background="images/button1_bg.jpg"><a href="capplydetails.php" title="已申请职位">已申请职位</a></td>
		...
		echo "<a href='candidateslogin.php' >求职者登陆</a>&nbsp;&nbsp";
		}
		?></td>
