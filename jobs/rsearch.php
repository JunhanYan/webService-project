...
<?php
	$pagesize=10;
	$sql = "select * from jobs where ".$_POST[seltype]." like ('%".$_POST[coun]."%') and rid='".$_SESSION['rid']."'";
	...
	$sql="select * from jobs where ".$_POST[seltype]." like ('%".$_POST[coun]."%') and rid='".$_SESSION['rid']."' order by jobid desc limit $startno,$pagesize";
	$rs=mysql_query($sql);
